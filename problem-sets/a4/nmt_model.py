...
class NMT(nn.Module):
    ...
    def encode(self, source_padded: torch.Tensor, source_lengths: List[int]) -> Tuple[torch.Tensor, Tuple[torch.Tensor, torch.Tensor]]:
        ...
        dec_init_state = (self.h_projection(last_hidden_cat), self.c_projection(last_cell_cat))
    ...
    def step(self, Ybar_t: torch.Tensor,
        ...
        e_t = torch.einsum('ik, ijk -> ij', dec_hidden, enc_hiddens_proj)
        ...
        a_t = torch.einsum('ij, ijk -> ik', alpha_t, enc_hiddens) 
